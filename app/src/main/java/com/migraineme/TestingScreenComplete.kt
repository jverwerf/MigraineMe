...
fun TestingScreenComplete(
    ...
    // Local nudge for status recompute (still needed by SleepSyncStatus)
    ...
    Column(
        ...
        // ----- Weather API by location points -----
        Spacer(Modifier.padding(10.dp))
        SectionHeader("Weather API by location points")
        TableCard(title = "joined: user_location_daily × city_weather_daily") {
...
class TestingViewModel : ViewModel() {
    ...
    /* Removed launchBackfillThenToday – not needed anymore */
